class GoodsDetailEntity {
	...
	GoodsDetailEntity.fromJson(Map<String, dynamic> json) {
		if (json['specificationList'] != null) {
			specificationList = [];(json['specificationList'] as List).forEach((v) { specificationList?.add(new GoodsDetailSpecificationlist.fromJson(v)); });
		}
		if (json['groupon'] != null) {
			groupon = [];
		}
		if (json['issue'] != null) {
			issue = [];(json['issue'] as List).forEach((v) { issue?.add(new GoodsDetailIssue.fromJson(v)); });
		}
		...
		if (json['attribute'] != null) {
			attribute = [];(json['attribute'] as List).forEach((v) { attribute?.add(new GoodsDetailAttribute.fromJson(v)); });
		}
		brand = json['brand'] != null ? new GoodsDetailBrand.fromJson(json['brand']) : null;
		if (json['productList'] != null) {
			productList = [];(json['productList'] as List).forEach((v) { productList?.add(new GoodsDetailProductlist.fromJson(v)); });
		}
...
class GoodsDetailSpecificationlist {
	...
	GoodsDetailSpecificationlist.fromJson(Map<String, dynamic> json) {
		if (json['valueList'] != null) {
			valueList = [];(json['valueList'] as List).forEach((v) { valueList?.add(new GoodsDetailSpecificationlistValuelist.fromJson(v)); });
		}
		name = json['name'];
	}
