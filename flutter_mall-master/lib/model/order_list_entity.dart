class OrderListEntity {
	...
	OrderListEntity.fromJson(Map<String, dynamic> json) {
		...
		page = json['page'];
		if (json['list'] != null) {
			xList = [];(json['list'] as List).forEach((v) { xList?.add(new OrderEntity.fromJson(v)); });
		}
	}
...
class OrderEntity {
	...
	OrderEntity.fromJson(Map<String, dynamic> json) {
		...
		if (json['goodsList'] != null) {
			goodsList = [];(json['goodsList'] as List).forEach((v) { goodsList?.add(new OrderGoodsEntity.fromJson(v)); });
		}
		id = json['id'];
